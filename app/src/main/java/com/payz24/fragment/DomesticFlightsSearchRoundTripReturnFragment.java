...
import com.payz24.adapter.DomesticFlightsSearchRoundTripReturnFragmentAdapter;
...
public class DomesticFlightsSearchRoundTripReturnFragment extends Fragment implements DomesticFlightsSearchRoundTripReturnFragmentAdapter.ItemClickListener, View.OnClickListener, FlightFilterCallBack {
    ...
    private DomesticFlightsSearchRoundTripReturnFragmentAdapter domesticFlightsSearchRoundTripReturnFragmentAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        prepareResult();
        initializeAdapter();
        prepareListOfFlightNames(listOfOriginDestinationOption);
        return view;
    }

    private void initializeListeners() {
        ivReturnFilter.setOnClickListener(this);
    }
    ...
    private void initializeUi(View view) {
        ...
        AppController.getInstance().setDomesticFlightsSearchRoundTripReturnFragmentContext(this);
    }

    private void prepareResult() {
        ResponseReturn responseReturn = AppController.getInstance().getResponseReturn();
        if (responseReturn != null) {
            rvFlightDetails.setVisibility(View.VISIBLE);
            tvError.setVisibility(View.GONE);
            listOfOriginDestinationOption = responseReturn.getOriginDestinationOptions().getOriginDestinationOption();
    ...
    private void prepareListOfFlightNames(List<OriginDestinationOption> listOfOriginDestinationOption) {
        ...
        for (int index = 0; index < listOfOriginDestinationOption.size(); index++) {
    ...
    private void initializeAdapter() {
        domesticFlightsSearchRoundTripReturnFragmentAdapter = new DomesticFlightsSearchRoundTripReturnFragmentAdapter(getActivity(), listOfOriginDestinationOption, rvFlightDetails);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        domesticFlightsSearchRoundTripReturnFragmentAdapter.setClickListener(this);
        rvFlightDetails.setLayoutManager(layoutManager);
        rvFlightDetails.setItemAnimator(new DefaultItemAnimator());
        rvFlightDetails.setAdapter(domesticFlightsSearchRoundTripReturnFragmentAdapter);
    }
    ...
    public void onClick(View view, int position) {
        ...
        roundTripFlightSelectedCallBack.roundTripFlightSelected(originDestinationOption, getString(R.string.destination));
        previousView = view;
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.ivReturnFilter:
                ...
                flightsFilterIntent.putExtra(getString(R.string.from), getString(R.string.domestic_flight_search_round_trip_return));
    ...
    public void flightFilter(boolean isNonStopSelected, boolean isOneStopSelected, boolean isTwoStopSelected, boolean isBeforeElevenAM, boolean isElevenAM, boolean isFivePM, boolean isAfterNinePM, LinkedList<String> listOfCheckNames) {
        ...
        if (!isNonStopSelected && !isOneStopSelected && !isTwoStopSelected && !isBeforeElevenAM && !isElevenAM && !isFivePM && !isAfterNinePM && listOfCheckNames.size() == 0) {
            ...
            domesticFlightsSearchRoundTripReturnFragmentAdapter.update(listOfOriginDestinations);
        } else {
