...
public class TwoGFragment extends BaseFragment implements HttpReqResCallBack, ViewPlansAdapter.ItemClickListener {
    ...
    private void serviceCallForViewPlans() {
        ...
        mapOfRequestParams.put(Constants.VIEW_PLANS_PARAM_TYPE, getString(R.string.two_g_short_code));
    ...
    private void initializeAdapter() {
        ViewPlansAdapter viewPlansAdapter = new ViewPlansAdapter(getActivity(), listOfViewPlans, getString(R.string.two_g_short_code));
