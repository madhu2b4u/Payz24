...
public class DatacardActivity extends BaseActivity implements HttpReqResCallBack, RadioGroup.OnCheckedChangeListener, View.OnClickListener, ContactsCallBack, RechargeAmountCallBack {
    ...
    private void initializeUi() {
        ...
        toolbar.setTitle(getString(R.string.data_recharges));
        setSupportActionBar(toolbar);
        ImageView  icon= findViewById(R.id.recharge_icon);
        icon.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_datacard));
    ...
    private void goToViewPlans(String serviceProviderName, String circleName) {
        if (!serviceProviderName.isEmpty() && !circleName.isEmpty()) {
            Intent viewPlansIntent = new Intent(this, DataCardPlansActivity.class);
    ...
    public void networkProvider()
    {
        ...
        item.add("BSNL");
        item.add("IDEA");
        item.add("MTNL MUMBAI");
        item.add("MTS");
        item.add("RELIANCE BROADBAND");
        item.add("RELIANCE DATACARD");
        item.add("TATA PHOTON");
        item.add("VODAFONE");
        ...
        dialogBuilder.setItems(networks, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
               ...
               if(selectedNetwork.equals("MTNL MUMBAI"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DMM";
                    Log.e("serviceProviderId",serviceProviderId);

                }if(selectedNetwork.equals("RELIANCE BROADBAND"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DRB";
                    Log.e("serviceProviderId",serviceProviderId);

                }
                if(selectedNetwork.equals("RELIANCE DATACARD"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DRD";
                    Log.e("serviceProviderId",serviceProviderId);
                ...
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DI";
                    Log.e("serviceProviderId",serviceProviderId);

                }  if(selectedNetwork.equals("AIRCEL"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DAC";
                    Log.e("serviceProviderId",serviceProviderId);

                }if(selectedNetwork.equals("AIRTEL"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DAR";
                    Log.e("serviceProviderId",serviceProviderId);
                }if(selectedNetwork.equals("MTS"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DM";
                    Log.e("serviceProviderId",serviceProviderId);
                }if(selectedNetwork.equals("VODAFONE"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DV";
                    Log.e("serviceProviderId",serviceProviderId);
                }if(selectedNetwork.equals("TATA PHOTON"))
                {
                    tvOperatorName.setText(selectedNetwork);
                    serviceProviderId="DTP";
                    Log.e("serviceProviderId",serviceProviderId);
                }
