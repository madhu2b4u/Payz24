...
public class DomesticFlightsSearchRoundTripReturnFragmentAdapter extends RecyclerView.Adapter<DomesticFlightsSearchRoundTripReturnFragmentAdapter.ViewHolder> {
    ...
    public DomesticFlightsSearchRoundTripReturnFragmentAdapter(Context context, List<OriginDestinationOption> listOfOriginDestinationOption, RecyclerView rvFlightDetails) {
    ...
    public void update(List<OriginDestinationOption> listOfOriginDestinations) {
        this.listOfOriginDestinationOption = listOfOriginDestinations;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Log.e("Domesticroundtrip","Domesticroundtrip");
