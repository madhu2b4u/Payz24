...
public class RechargePayBillAdapter extends RecyclerView.Adapter<RechargePayBillAdapter.ViewHolder> {
    ...
    public RechargePayBillAdapter(Context context, LinkedList<String> listOfCollectionNames, LinkedList<Integer> listOfCollectionImages) {
    ...
    public interface ItemClickListener {
        void onRechargePayBillClickListener(View view, int position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (clickListener != null)
                clickListener.onRechargePayBillClickListener(view, getLayoutPosition());
        }
    }
}
