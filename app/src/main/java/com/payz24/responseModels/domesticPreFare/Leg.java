...
public class Leg {
    ...
    public Leg(String airEquipType, String arrivalAirportCode, String arrivalDateTime, String departureAirportCode, String departureDateTime, String flightNumber,
               String operatingAirlineCode, String operatingAirlineFlightNumber, String rPH, String airLineName, String airportTax, String imageFileName, String viaFlight,
               String stopQuantity, String availability, String resBookDesigCode, String adultFare, String bookingclass, String classType, String farebasiscode, String rule,
               String infantfare, String childFare, String adultCommission, String childCommission, String commissionOnTCharge, String discount, String airportTaxChild,
               String airportTaxInfant, String adultTaxBreakup, String childTaxBreakup, String infantTaxBreakup, String octax) {
